 ...
 */
final class Version20220316144757 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE mail ADD bien_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE mail ADD CONSTRAINT FK_5126AC48BD95B80F FOREIGN KEY (bien_id) REFERENCES bien (id)');
